    ...
    <div>
      ...
      <div style={{ position: "relative" }}>
        <div style={{
          ...
          {ast && tab === "diagram" && <SequenceDiagram />}
          {ast && tab === "ast" && <pre style={{ margin: 0, fontSize: 11, color: C.muted, lineHeight: 1.7, textAlign: 'left' }}>{JSON.stringify(ast, null, 2)}</pre>}
        </div>
