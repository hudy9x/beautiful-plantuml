...
// ── ZoomPanContainer ──────────────────────────────────────────────────────────
//
// Uses a CSS transform on a <div> so it works with any children —
// SVG elements, React components, HTML, etc.
    ...
    >
      ...
      <div
        style={{
          ...
          // Allow pointer events on children (e.g. svg elements)
          pointerEvents: 'none',
        }}
      >
      ...
      <div style={{
        ...
        gap: 6,
        zIndex: 20,
        // Prevent drag from triggering on controls
        pointerEvents: 'all',
      }}
