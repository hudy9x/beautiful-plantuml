---
name: tool:design
description: Applies a "WIRED Magazine" editorial aesthetic to UI components and layouts. Use when building high-density, typographic-heavy interfaces that require a "printerly" feel (square corners, hairline rules, zero shadows).
---
